...
const FilePictures_routes_1 = __importDefault(require("@/modules/filePictures/api/routes/FilePictures.routes"));
...
router.use('/pictures', FilePictures_routes_1.default);
